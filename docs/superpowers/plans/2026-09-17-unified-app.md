...
Validation: web lint, TypeScript and unit tests; mocked build-wrapper checks; production image build; isolated desktop/mobile/dark visual inspection and functional checks; deployment with consistent backup and preserved data counts; refreshed English screenshots and private repository documentation.
