...
<p align="center">
  <img src="site/assets/screenshots/dashboard.webp?v=blue-post-20260917" alt="Amfora workspace dashboard" width="100%" />
</p>
...
![Amfora dashboard](site/assets/screenshots/dashboard.webp?v=blue-post-20260917)

The dashboard brings uploads, shares, receive links, storage usage, and recent
files into one starting point.

![Amfora send view](site/assets/screenshots/download.webp?v=blue-post-20260917)

A share presents its files and delivery rules in a focused download view.

![Amfora receive view](site/assets/screenshots/upload.webp?v=blue-post-20260917)

A receive link gives outside collaborators a simple upload form with the limits
set by its owner.

![Amfora sign-in](site/assets/screenshots/login.webp?v=blue-post-20260917)
